...
def dealer_hit():
	...
	if dealer_spot < 5:
		try:
			...
			if dealer_spot == 0:
				# Resize Card
				dealer_image1 = resize_cards(f'./images/deck/{dealer_card}.png')
				# Output Card To Screen
				...
				# Resize Card
				dealer_image2 = resize_cards(f'./images/deck/{dealer_card}.png')
				# Output Card To Screen
				...
				# Resize Card
				dealer_image3 = resize_cards(f'./images/deck/{dealer_card}.png')
				# Output Card To Screen
				...
				# Resize Card
				dealer_image4 = resize_cards(f'./images/deck/{dealer_card}.png')
				# Output Card To Screen
				...
				# Resize Card
				dealer_image5 = resize_cards(f'./images/deck/{dealer_card}.png')
				# Output Card To Screen
...
def player_hit():
	...
	if player_spot < 5:
		try:
			...
			if player_spot == 0:
				# Resize Card
				player_image1 = resize_cards(f'./images/deck/{player_card}.png')
				# Output Card To Screen
				...
				# Resize Card
				player_image2 = resize_cards(f'./images/deck/{player_card}.png')
				# Output Card To Screen
				...
				# Resize Card
				player_image3 = resize_cards(f'./images/deck/{player_card}.png')
				# Output Card To Screen
				...
				# Resize Card
				player_image4 = resize_cards(f'./images/deck/{player_card}.png')
				# Output Card To Screen
				...
				# Resize Card
				player_image5 = resize_cards(f'./images/deck/{player_card}.png')
				# Output Card To Screen
